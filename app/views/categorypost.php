                        ...
                        <ul class="list_ul">
                           <li class="lists">
                              <div class="img-list">
                                 ...
                                 <img src="<?php echo BASE_URL ?>public/images/iphone.png" alt="So sánh công nghệ hiển thị 3LCD và DLP" class="img-list-in">
                                 </a>
                              </div>
                              <div class="content-list">
                                 <div class="content-list_inm">
                                    <div class="title-list">
                                       <h3>
                                          <a href="<?php echo BASE_URL ?>news/news_detail/12">So sánh công nghệ hiển thị 3LCD và DLP</a>
                                       </h3>
