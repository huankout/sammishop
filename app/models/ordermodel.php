<?php
	...
	class ordermodel extends DModel
	{
        ...
        public function list_order_details($table_product,$table_order_details,$cond){
            $sql = "SELECT * FROM $table_order_details,$table_product WHERE $cond ORDER BY order_detail_id DESC";
            return $this->db->select($sql);
        }
        public function list_order_info($table_order_details,$cond_info){
